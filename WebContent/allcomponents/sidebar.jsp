		...
		<div class="sidebar-inner slimscroll">
			<div id="sidebar-menu" class="sidebar-menu">
				<ul>
					...
					<li><a href="add-school.jsp"><i class="fas fa-border-all"></i>
							<span>Dashboard</span></a></li>
					<li class="submenu"><a href="#"><i class="fas fa-school"></i>
							<span> School</span> <span class="menu-arrow"></span></a>
						<ul>
							<li><a href="students.html">School List</a></li>
							<li><a href="addSchool.jsp">School Add</a></li>
							<li><a href="add-student.html">Student Update</a></li>
						</ul></li>
